...
<li id="preprint-{{ forloop.rindex }}" style="margin-bottom: 15px;">
<div class="pub-row" style="display: flex; min-height: auto">
  ...
  <div style="flex: 0 0 30px; align-self: flex-start; text-align: center; font-weight: bold; color: #555;">
    [{{ forloop.rindex }}]
  </div>
  ...
  <div style="flex: 1; position: relative; padding-right: 15px; padding-left: 10px; align-self: flex-start;">
    ...
    {% if link.abstract %}
      <div id="abs-{{ link.title | slugify }}" class="abstract-panel" style="display: none; margin-top: 10px; padding: 12px; font-size: 13px; line-height: 1.5; border-radius: 0 4px 4px 0;">
        {{ link.abstract }}
      </div>
    {% endif %}
  </div>
